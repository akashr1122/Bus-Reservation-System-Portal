...
async function AvailableBusInRoot() {
    ...
    bus.forEach(ele => {
        ...
        heroImg.src = "https://assets.volvo.com/is/image/VolvoInformationTechnologyAB/1860x1050-volvo-9700-CGI1?qlt=82&wid=1024&ts=1656931444230&dpr=off&fit=constrain";
        ...
        btn.onclick = function () {
            ...
            //console.log(data)
            postData('http://localhost:8080/reservation/add', data)
                .then((data) => {
